...
const DEFAULT_SECTIONS = [
  ...
  { title: 'Rescheduling & No-Show Policy', rules: ['Rescheduling must be done at least twenty-four (24) hours before the class start time.', 'Missed classes are forfeited — no credit will be given for classes not attended.', 'A $20 no-show fee applies if you miss a rescheduled class, as that spot could have gone to another student.'] },
