# VES Pottery Gallery - Student Management System

> **📋 READ FIRST:** See [SYSTEM_RULES.md](./SYSTEM_RULES.md) for critical setup requirements and class system rules.

A professional student pottery portfolio and class management system for Shopify customer accounts. Students can view all their completed ceramic pieces with detailed specifications, images, and progress tracking.
