...
function generate({ dayOfWeek, startDate, endDate, timeSlot, holidayExclusions, collectionStart, collectionEnd, disposalDate, specialNotes }) {
  ...
  const body = `
    ...
    <p style="margin: 0 0 20px; font-size: 14px; line-height: 1.7; color: #282828;">
      This package includes a 6-week structured wheelthrowing course plus 4 flexible classes that can be used for additional wheelthrowing or handbuilding sessions. The first 6 weeks will teach you the fundamentals of wheel-throwing — cylinder and bowl forms, trimming techniques, and glazing using special VES glazes. The remaining 4 classes can be booked at your convenience to continue practising or explore handbuilding.
    </p>
